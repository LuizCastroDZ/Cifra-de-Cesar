...
chave = input("\nEscolha uma chave: ")                                              #Declarar chave para segurança do codigo.
...
while i < 2:
  ...
  if escolha == "1":                                                                #Criptografar a mensagem
    ...
    select_chave = input("\nDigite a chave: ")
    if select_chave == chave:                                                       #Variavel que verifica se a chave digitada e igual a chave selecionada.
      ...
      if continuar == "1":
        ...
        i += 1
        print("\nAte mais!")
    else:                                                                           #Se a chave for errada, ele para o codigo.
      print("Chave errada")
      i += 1
